...
@section('script')
    <script>
        ...
        $('.variation-select').on('change', function (e) {
            let variation = JSON.parse(this.value);
            let variationPriceDiv = $('.variation-price-' + $(this).data('id'));
            // let variationPriceDiv = $('.variation-price-' + variation.id);
            variationPriceDiv.empty();
            ...
            $('#productModal-' + $(this).data('id') + ' .quantity-input').attr('data-max', variation.quantity);
            $('.quantity-input').val(1);
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-6">
                                <div class="slider-single-img slider-animated-1">
                                    <img class="animated"
                                         src="{{ asset(env('BANNER_IMAGE_UPLOAD_PATH').$slider->image) }}"
                                         alt="{{ $slider->image }}"/>
                                </div>
                            </div>
                        </div>
                ...
                @foreach ($indexTopBanners->chunk(3)->first() as $banner)
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href="#">
                                <img class="animated"
                                     src="{{ asset(env('BANNER_IMAGE_UPLOAD_PATH') . $banner->image) }}"
                                     alt=""/>
                            </a>
                                                ...
                                                <li>
                                                    @auth()
                                                        @if($product->checkUserWishlist(auth()->id()))
                                                            <a href="{{ route('add-to-wishlist',['product'=>$product->id]) }}"><i
            ...
            <div class="row">
                @foreach ($indexBottomBanners as $banner)
                    <div class="col-lg-6 col-md-6 text-right">
                        <div class="single-banner mb-30 scroll-zoom">
                            <a href=""><img src="{{ asset(env('BANNER_IMAGE_UPLOAD_PATH') . $banner->image) }}" alt=""/></a>
