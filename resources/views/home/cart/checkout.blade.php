        ...
        <div class="container">
            ...
            <div class="checkout-wrap pt-30">
                <div class="row">
                    ...
                    <div class="col-lg-5">
                        <form id="checkout-form" action="{{route('home.payment.send')}}" method="POST">
                            @csrf
                            <div class="your-order-area">
                                ...
                                <div class="your-order-wrap gray-bg-4">
                                    ...
                                    <div class="payment-method">
                                        <div class="pay-top sin-payment">
                                            <input id="paystar" class="input-radio" type="radio" value="paystar"
                                                   checked="checked" name="payment_method">
                                            <label for="paystar"> درگاه پرداخت Pay star </label>
                                ...
                                <div class="Place-order mt-40">
                                    <button class="mb-3 btn btn-primary" type="button" data-toggle="modal"
                                            data-target="#exampleModal">
                                        @if(auth()->user()->card_number)
                                            ویرایش کارت بانکی
                                        @else
                                            وارد کردن کارت بانکی
                                        @endif
                                    </button>
                            ...
                            <input type="hidden" id="address-input" name="card_number">
                        </form>
                    </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{route('home.cart.update.card.no')}}" method="post">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">ثبت کارت بانکی</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="message-text" class="col-form-label">شماره کارت:</label>
                            <input value="{{auth()->user()->card_number}}" name="card_number" class="form-control"
                                   id="message-text" type="text" required>
                        </div>
